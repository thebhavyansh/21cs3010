...
The API also includes Role-Based Access Control (RBAC) with two user roles:

Admin: Can perform administrative tasks like adding new trains.
User: Can check train availability, book seats, and view booking details.
Features
